...
function! s:get_non_existent_contained_dir_stub(name)
	return { 'exists' : 0}
endfunction

function! s:get_existing_contained_dir_stub(name)
	return { 'exists' : 1}
endfunction
...
function! s:Test_when_parent_is_proj_root()
	let dir= { 'get_contained_dir' : function('s:get_non_existent_contained_dir_stub') }
	function! dir.parent()
		let parent= { 'get_contained_dir' : function('s:get_existing_contained_dir_stub') }
		return parent
	endfunction
